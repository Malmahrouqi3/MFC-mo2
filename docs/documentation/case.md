...
<body>
    <div class="container">
        <div class="header">
            <h1>🗺️ Feature Compatibility Map</h1>
            <p>Click features to build a compatible configuration path</p>
        </div>
        
        <div class="content">
            <div class="sidebar">
                <h2>Selection Path</h2>
                <p class="subtitle">Features selected in order</p>
                ...
                <div class="stats" id="stats">
                    ...
                    <div class="stats-row">
                        ...
                        <span class="stats-value" id="availableCount">8</span>
                    </div>
                    <div class="stats-row">
                        <span class="stats-label">Total:</span>
                        <span class="stats-value" id="totalCount">8</span>
                    </div>
                </div>
                
                <button class="reset-btn" onclick="resetSelection()">Start Over</button>
            </div>
            ...
            <div class="map-container" id="mapContainer">
                ...
                <div class="legend">
                    ...
                    <div class="legend-item">
                        <div class="legend-color incompatible"></div>
    ...
    <script>
        ...
        function updateAvailableFeatures() {
            ...
            // Find features compatible with ALL selected features
        ...
        function drawConnections() {
            ...
            // Draw lines from selected features to available features
