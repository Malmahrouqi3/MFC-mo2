                    ...
                    do l = is3%beg, is3%end
                        do k = is2%beg, is2%end
                            do j = is1%beg, is1%end
                                ...
                                else if (mpp_lim .and. (num_fluids > 2)) then
                                    $:GPU_LOOP(parallelism='[seq]')
                                    do i = 1, num_fluids
                                        rho_L = rho_L + qL_prim_rs${XYZ}$_vf(j, k, l, i)
                                        gamma_L = gamma_L + qL_prim_rs${XYZ}$_vf(j, k, l, E_idx + i)*gammas(i)
                                ...
                                if (model_eqns == 2 .and. viscous) then
                                ...
                                if (model_eqns == 2 .and. bubbles_euler) qv_L = 0
                                if (model_eqns == 2 .and. bubbles_euler) qv_R = 0
                                    ...
                                    if (avg_state == 2) then
                                        ...
                                        if (.not. qbmm) then
                                            if (adv_n) then
                                                ...
                                                nbub_L_denom = 0._wp; nbub_R_denom = 0._wp
                                                $:GPU_LOOP(parallelism='[seq]')
                                                do i = 1, nb
                                        ...
                                        if (qbmm) then
                                            ...
                                            PbwR3Lbar = 0._wp; PbwR3Rbar = 0._wp
                                            R3Lbar = 0._wp; R3Rbar = 0._wp
                                            R3V2Lbar = 0._wp; R3V2Rbar = 0._wp
                                ...
                                if ((model_eqns == 2 .and. bubbles_euler) .and. (num_fluids > 1)) then
